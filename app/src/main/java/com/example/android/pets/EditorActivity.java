...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    static final int EDITOR_MODE = 1000;
    static final int ADD_MODE = 1001;
    int mode;
    Uri petUriData;
    ...
    private void savePet() {
        ...
        switch (mode) {
            case (EDITOR_MODE):
                int rowsUpdated = getContentResolver().update(petUriData, values, null, null);
                if (rowsUpdated > 0) {
                    Toast.makeText(this, "You updated " + rowsUpdated + " rows", Toast.LENGTH_SHORT).show();
                } else {
            ...
            case (ADD_MODE):
                ...
                break;
            default:
                throw new IllegalArgumentException("Editor Activity Mode unknown");
        }
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                if (TextUtils.isEmpty(mNameEditText.getText())
                        && (!TextUtils.isEmpty(mBreedEditText.getText())
                        || !TextUtils.isEmpty(mWeightEditText.getText()))) {
                    Toast.makeText(this, "Please provide pet name before saving.", Toast.LENGTH_LONG).show();
                    return true;
                }
                savePet();
                finish();
    ...
    private void deletePet() {
        if (mode == EDITOR_MODE) {
            ...
            int rowsDeleted = getContentResolver().delete(petUriData, null, null);
            if (rowsDeleted > 0) {
                Toast.makeText(this, R.string.pet_deleted_toast, Toast.LENGTH_SHORT).show();
            } else {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return new CursorLoader(this, petUriData,
                null, null, null, null);
    }
